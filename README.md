...
| 旧命令 | 当前行为 |
|------|------|
| `/汤 [题号]` | 等价于 `/开始海龟汤 [题号]`；旧题库参数请改用 `question_source` 配置 |
| `/揭晓`、`/揭示` | 等价于 `/公布答案` |
| `/汤状态`、`/汤面` | 查看当前题号、题面和提问次数 |
| `/提问列表 [页码]` | 查看本局已经完成判题的问答记录，每页 10 条 |
...
3. **提问推理**：玩家使用 `@机器人 问题` 或 `/提问 问题` 提出问题
